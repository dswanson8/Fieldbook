...
function gatherAsbElevStations(){const out=[];state.setups.forEach((s,si)=>{s.rows.forEach((r,ri)=>{if(r.type==='FS'&&isNum(r.elev)){out.push({setup:si,index:ri,station:r.station||'',elev:r.elev,source:'FS Elev'})}})});out.sort((a,b)=>(b.setup-a.setup)||(a.index-b.index));return out}
